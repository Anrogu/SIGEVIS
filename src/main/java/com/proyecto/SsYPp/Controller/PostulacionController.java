...
public class PostulacionController {
    ...
    public String deletePostulacion(@PathVariable Long id){ // Parameter changed from 'usuario' to 'id'
    ...
    @PostMapping("/create")
    public ResponseEntity<PostulacionDto> registerPostulacion(@Valid @ModelAttribute PostulacionDto postulacion) {
